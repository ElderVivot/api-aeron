...
exports.CompanieController = void 0;
...
let CompanieController = class CompanieController {
    constructor(service) {
    ...
    async indexOnlyIDCompanie(tenant, dto, res) {
...
], CompanieController.prototype, "index", null);
__decorate([
    (0, common_1.Get)('/get_list_idCompanie'),
    __param(0, (0, common_1.Headers)('tenant')),
    __param(1, (0, common_1.Query)(validation_custom_pipe_1.ValidationPipeCustom)),
    __param(2, (0, common_1.Res)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, filter_dto_1.FilterDto, Object]),
    __metadata("design:returntype", Promise)
], CompanieController.prototype, "indexOnlyIDCompanie", null);
__decorate([
    (0, common_1.Get)('/:id'),
    __param(0, (0, common_1.Headers)('tenant')),
    ...
    __metadata("design:returntype", Promise)
], CompanieController.prototype, "show", null);
__decorate([
    (0, common_1.Post)(),
    __param(0, (0, common_1.Headers)('tenant')),
    ...
    __metadata("design:returntype", Promise)
], CompanieController.prototype, "store", null);
__decorate([
    ...
    __metadata("design:paramtypes", [String, String]),
    __metadata("design:returntype", Promise)
], CompanieController.prototype, "destroy", null);
__decorate([
    (0, common_1.Put)('/:id'),
    __param(0, (0, common_1.Headers)('tenant')),
    __param(1, (0, common_1.Param)('id', common_1.ParseUUIDPipe)),
    ...
    __metadata("design:returntype", Promise)
], CompanieController.prototype, "update", null);
CompanieController = __decorate([
    (0, common_1.Controller)('companie'),
    __metadata("design:paramtypes", [companie_service_1.CompanieService])
], CompanieController);
exports.CompanieController = CompanieController;
//# sourceMappingURL=companie.controller.js.map