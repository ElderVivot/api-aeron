...
exports.LogNotaFiscalController = void 0;
...
let LogNotaFiscalController = class LogNotaFiscalController {
    constructor(service) {
    ...
    async getCompaniesThatDontProcessNotaFiscalYet(tenant, dto) {
...
], LogNotaFiscalController.prototype, "index", null);
__decorate([
    ...
    __metadata("design:returntype", Promise)
], LogNotaFiscalController.prototype, "indexToFront", null);
__decorate([
    (0, common_1.Get)('/get_companies_that_dont_process_yet'),
    __param(0, (0, common_1.Headers)('tenant')),
    __param(1, (0, common_1.Query)(validation_custom_pipe_1.ValidationPipeCustom)),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, filter_dto_1.FilterDto]),
    __metadata("design:returntype", Promise)
], LogNotaFiscalController.prototype, "getCompaniesThatDontProcessNotaFiscalYet", null);
__decorate([
    (0, common_1.Get)('/:id'),
    __param(0, (0, common_1.Headers)('tenant')),
    ...
    __metadata("design:returntype", Promise)
], LogNotaFiscalController.prototype, "show", null);
__decorate([
    (0, common_1.Post)(),
    __param(0, (0, common_1.Headers)('tenant')),
    ...
    __metadata("design:returntype", Promise)
], LogNotaFiscalController.prototype, "store", null);
__decorate([
    (0, common_1.Put)('/:id'),
    __param(0, (0, common_1.Headers)('tenant')),
    __param(1, (0, common_1.Param)('id', common_1.ParseUUIDPipe)),
    ...
    __metadata("design:returntype", Promise)
], LogNotaFiscalController.prototype, "update", null);
__decorate([
    ...
    __metadata("design:returntype", Promise)
], LogNotaFiscalController.prototype, "uploadPrintLog", null);
LogNotaFiscalController = __decorate([
    (0, common_1.Controller)('log_nota_fiscal'),
    __metadata("design:paramtypes", [log_nota_fiscal_service_1.LogNotaFiscalService])
], LogNotaFiscalController);
exports.LogNotaFiscalController = LogNotaFiscalController;
//# sourceMappingURL=log-nota-fiscal.controller.js.map